package com.hu6r1s.notification.email;

import com.hu6r1s.notification.kafka.order.Product;
...
public class EmailService {
  ...
  public void sentPaymentSuccessEmail(
    ...
    messageHelper.setFrom("contact@hu6r1s.com");
  ...
  public void sendOrderConfirmationEmail(
    ...
    try {
      ...
      mailSender.send(mimeMessage);
      log.info(
          String.format("INFO - Email successfully sent to %s with template %s ", destinationEmail,
              templateName));
    } catch (MessagingException e) {
      log.warn("WARNING - Cannot send Email to {} ", destinationEmail);
    }
